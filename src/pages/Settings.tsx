...
const Settings = () => {
  ...
  const tabs = [
    { id: 'general', label: 'Genel Ayarlar', icon: SettingsIcon, description: 'Sistem genel ayarları ve tercihler' },
    { id: 'lead-assignment', label: 'Lead Atama', icon: UserPlus, description: 'Lead atama kuralları ve KPI metrikleri' },
    { id: 'integrations', label: 'Entegrasyonlar', icon: Zap, description: 'Harici servisler ve API entegrasyonları' },
    { id: 'roles', label: 'Roller ve İzinler', icon: Shield, description: 'Kullanıcı rolleri ve yetkilendirme' },
    { id: 'users', label: 'Kullanıcı Yönetimi', icon: Users, description: 'Kullanıcı hesapları ve erişim kontrolü' },
    { id: 'notifications', label: 'Bildirim Ayarları', icon: Bell, description: 'Sistem bildirimleri ve hatırlatıcılar' },
    { id: 'language', label: 'Dil Ayarları', icon: Globe, description: 'Dil, para birimi ve bölge ayarları' },
    { id: 'email', label: 'E-Posta Ayarları', icon: Mail, description: 'SMTP yapılandırması ve şablonlar' },
    { id: 'clinic', label: 'Klinik Yönetimi', icon: Building2, description: 'Klinik ve şube bilgileri' },
    { id: 'payment', label: 'Ödeme Ayarları', icon: CreditCard, description: 'Ödeme yöntemleri ve gateway yapılandırması' },
    { id: 'templates', label: 'Belge Şablonları', icon: FileText, description: 'Sözleşme ve form şablonları' },
    { id: 'reports', label: 'Raporlama ve Analiz', icon: BarChart3, description: 'Raporlama ve analiz yapılandırması' },
    { id: 'legal-security', label: 'Yasal & Güvenlik', icon: Shield, description: 'KVKK/GDPR uyumu ve güvenlik politikaları' },
    { id: 'ai-automation', label: 'AI & Otomasyon', icon: Bot, description: 'Yapay zeka ve otomasyon ayarları' },
    { id: 'inventory', label: 'Stok Yönetimi', icon: Package, description: 'Envanter ve stok takip sistemi' },
    { id: 'partners', label: 'Partner Yönetimi', icon: Handshake, description: 'Dış ortaklar ve acenta yönetimi' },
    { id: 'payments', label: 'Ödeme & Finans', icon: CreditCard, description: 'Ödeme sistemleri ve finansal yönetim' },
    { id: 'patient-portal', label: 'Hasta Portalı', icon: Globe, description: 'Hasta portal ayarları ve yönetimi' },
    { id: 'help', label: 'Yardım ve Destek', icon: HelpCircle, description: 'Dokümantasyon ve destek kaynakları' }
  ];
