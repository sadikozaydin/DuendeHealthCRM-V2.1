  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Teklif Yönetimi</h1>
          <p className="text-gray-600 mt-1">Şablonlar, aktif teklifler ve fiyatlandırma yönetimi</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Gönderilen Teklifler</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {offerTemplates.map((template) => (
                  <div key={template.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex space-x-2">
                      <button className="flex-1 bg-blue-100 hover:bg-blue-200 text-blue-700 py-2 px-3 rounded text-sm transition-colors">
                        Önizle
                      </button>
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center space-x-2">
          ...
          <span>Akıllı Teklif Sistemi & Otomasyonlar</span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white p-4 rounded-lg">
            <h4 className="font-medium text-gray-900 mb-2">Dinamik Fiyatlandırma</h4>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Hasta profiline göre otomatik fiyat ayarı</li>
              <li>• Sezon ve talep bazlı fiyatlandırma</li>
              <li>• Rekabet analizi ve piyasa fiyatları</li>
              <li>• Özel indirim önerileri</li>
              <li>• Karlılık optimizasyonu</li>
            </ul>
          </div>
          
          <div className="bg-white p-4 rounded-lg">
            <h4 className="font-medium text-gray-900 mb-2">Otomatik Teklif Oluşturma</h4>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Lead profiline göre şablon önerisi</li>
              <li>• Çoklu dil desteği</li>
              <li>• Kişiselleştirilmiş içerik</li>
              <li>• Otomatik gönderim zamanlaması</li>
              <li>• A/B test desteği</li>
            </ul>
          </div>
          
          <div className="bg-white p-4 rounded-lg">
            <h4 className="font-medium text-gray-900 mb-2">Takip ve Analitik</h4>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Gerçek zamanlı teklif takibi</li>
